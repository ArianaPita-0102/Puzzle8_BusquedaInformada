...
% Las imágenes viven en experimentos/resultados/ (no se duplican acá para
% no tener dos copias del mismo archivo si se vuelven a correr los
% experimentos). Este .tex está en documentos/, un nivel por debajo de
...
\author{Nazaret Claure \and Igor Pereira \and Ariana Pita \and Maria Sandoval}
...
% TODO (equipo): agregar acá una o dos capturas de pantalla reales del juego
% (pantalla de selección de dificultad y tablero en juego), por ejemplo:
% \includegraphics[width=0.6\textwidth]{../../capturas/menu.png}
% \includegraphics[width=0.6\textwidth]{../../capturas/tablero.png}
...
\item Faltan capturas de pantalla reales del juego en este informe (ver nota
